...
public class DistanceMeasurment {
	public static void main(String[] args) {
		DistanceMeasurment m = new DistanceMeasurment();
		// 마일(Mile) 단위
		// double distanceMile =
		// distance(37.504198, 127.047967, 37.501025, 127.037701, "");

		// 미터(Meter) 단위
		double distanceMeter = m.distance(37.504198, 127.047967, 37.501025, 127.037701, "meter");
